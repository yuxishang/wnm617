...
const makeShopProfile = templater(o=>`
    <div class="flex-none heart js-deleteshop">
                    <a href="#" class="js-deleteshop" data-id="${o.id}"><span class="iconify" data-inline="false" data-icon="ant-design:delete-outlined" style="font-size: 30px;"></span></a>
        </div>
<div class="profile-image">
   <img src="${o.img}" style="position: absolute;width: 140px;height: 140px;left: 118px;top: 30px;border-radius: 50%; background-color:var(--color-neutral-light);"></div>
...
const makeRecentWindow = templater(o=>`
            ...
            <img src="${o.img}" style="width: 30%;margin-top: -100px; margin-left: 30px;">
            </a>
`);
